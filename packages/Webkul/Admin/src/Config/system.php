...
return [
    ...
    [
        ...
        'name' => 'Theme Colors & Fonts',
        'info' => 'Manage all colors, fonts, and theme presets for your storefront.',
        'sort' => 3,
        'fields' => [
            [
                'name' => 'theme_preset',
                ...
                'options' => [
                    ...
                    ['title' => 'Sunset (Deep Plum)', 'value' => 'sunset'],
                    ['title' => 'Forest (Deep Green)', 'value' => 'forest'],
                    ['title' => 'Ocean (Deep Teal)', 'value' => 'ocean'],
                    ['title' => 'Red (Crimson)', 'value' => 'red'],
                    ['title' => 'Maroon (Dark Maroon)', 'value' => 'maroon'],
