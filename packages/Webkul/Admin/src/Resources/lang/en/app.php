    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'image-alt-placeholder' => 'Image description (alt text)',
                'image-link-placeholder' => 'Link URL (optional)',
                'image-caption-placeholder' => 'Caption text (optional)',
                'image-upload-message' => 'Please select a valid image file (JPEG, PNG, WebP).',
                ...
                'no-images' => 'No images added yet.',
                'add-first-image' => 'Add Your First Image',
                'text-content' => 'Text Content',
                'text-content-placeholder' => 'Add your text content here...',
                ...
                'services-content' => [
                    ...
                    'service-icon-placeholder' => 'e.g. icon-truck',
                    'service-info' => 'Service related theme customization.',
                    'service-image' => 'Service Image',
                    'upload-image' => 'Upload Image',
                    'replace-image' => 'Replace Image',
                    'image-hint' => 'Upload an image icon. If provided, it will be used instead of the CSS icon class.',
                    'icon-hint' => 'CSS icon class (fallback if no image). E.g. icon-truck, icon-gift.',
                    'services' => 'Services',
                    'sort-order' => 'Sort Order',
                    'status' => 'Status',
                    'title' => 'Title',
